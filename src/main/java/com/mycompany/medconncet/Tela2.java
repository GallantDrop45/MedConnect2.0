...
public class Tela2 extends javax.swing.JFrame {
    ...
    public Tela2() {
        ...
        BotaoVolta1.setBackground(new java.awt.Color(0,0,0,1));
    }
    ...
    private void initComponents() {
        ...
        botão1.setBounds(1010, 380, 244, 65);

        BotaoVolta1.setForeground(new java.awt.Color(255, 255, 255));
        BotaoVolta1.setIcon(new javax.swing.ImageIcon("F:\\Faculdade\\A3-4 semestre\\de-volta.png")); // NOI18N
        BotaoVolta1.setBorder(null);
        BotaoVolta1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotaoVolta1ActionPerformed(evt);
            }
        });
        getContentPane().add(BotaoVolta1);
        BotaoVolta1.setBounds(120, 110, 64, 60);
